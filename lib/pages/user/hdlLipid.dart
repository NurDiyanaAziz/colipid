            ...
            decoration:BoxDecoration(
                  ...
                  padding: EdgeInsets.all(5),
                   ...
                   LinearPercentIndicator(
                    ...
                    center: Text('>1.45',style: TextStyle(fontSize: 15),),
                    lineHeight: 20.0,
                    percent: 0.2,
                 ...
                 LinearPercentIndicator(
                    ...
                    center: Text('>0.90 & <1.45',style: TextStyle(fontSize: 15),),
                   width: 120.0,
                    lineHeight: 20.0,
                    percent: 0.5,
                   ...
                   LinearPercentIndicator(
                     center: Text('<0.9',style: TextStyle(fontSize: 15),),
                    width: 120.0,
                    lineHeight: 20.0,
                    percent: 0.9,
                ...
                children: <Widget>[
                  Align(
                   ...
                   LinearPercentIndicator(
                    ...
                    center: Text('>1.68',style: TextStyle(fontSize: 15),),
                    lineHeight: 20.0,
                    percent: 0.2,
                    progressColor: Color.fromARGB(255, 54, 244, 86),
                  ),
                 ...
                 LinearPercentIndicator(
                    ...
                    center: Text('>1.15 & <1.68',style: TextStyle(fontSize: 15),),
                   width: 120.0,
                    lineHeight: 20.0,
                    percent: 0.5,
                    progressColor: Colors.orange,
                   ...
                   LinearPercentIndicator(
                     center: Text('<1.15',style: TextStyle(fontSize: 15),),
                    width: 120.0,
                    lineHeight: 20.0,
                    percent: 0.9,
                    progressColor: Color.fromARGB(255, 243, 33, 33),
